...
extension URL{
    ...
    static var trainingDirectoryinDec : URL? {
    ...
    static var datasetDirectory : URL? {
        return documentDirectory?.appendingPathComponent("Dataset", isDirectory: true)
    }
    ...
    static var defaultMLModel: URL? {
        return resourceDirectory?.appendingPathComponent("myMLModel.mlmodel")
    }
    
    static var soundDefaultMLModel : URL? {
        return resourceDirectory?.appendingPathComponent("SoundClassifier.mlmodel")
    }
